...
import com.shipox.demo.model.NotificationEmail;
...
import com.shipox.demo.repository.VerificationTokenRepository;
import com.shipox.demo.security.JwtProvider;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please activate your account",
                user.getEmail(), "Welcome to Twitter, " +
                "click on the url to activate your account : " +
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) {
        ...
        User user = userRepository.findByUsername(username).orElseThrow(() -> new TwitterCloneException("User name not found " + username));
